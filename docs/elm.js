...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {R: fragment, T: host, az: path, Y: port_, aa: protocol, ab: query};
	});
...
var $author$project$Main$oldPage = function (_v0) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Here\'s what I look like:')
						])),
					A2(
					$elm$html$Html$img,
					_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Here are my links:')
						])),
					A2(
					$elm$html$Html$nav,
					_List_Nil,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://lichess.org/@/kadenjtaylor')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Playing Chess')
										]))
								])),
							A2(
							$elm$html$Html$li,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Visualizing Symbolic Manipulation')
										]))
								])),
							A2(
							$elm$html$Html$li,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('pages/slider_demo')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Making slideshows in Rust+WASM')
										]))
								])),
							A2(
							$elm$html$Html$li,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('pages/musings/software_doesnt_have_clay.html')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Thinking about Software Clay')
										]))
								]))
						]))
				]))
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{au: $author$project$Main$init, aw: $author$project$Main$UrlChanged, ax: $author$project$Main$LinkClicked, aB: $author$project$Main$subscriptions, aC: $author$project$Main$update, aD: $author$project$Main$view});
