						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$alt(squareTitle)
								]),
							_List_Nil),
							A2(
							$elm$html$Html$p,
							...
							_List_fromArray(
								[
									$elm$html$Html$text(squareTitle)
								]))
						]))
				]));
	});
...
var $author$project$Projects$AbarthHatchbackSwitch$solution = A2(
	$elm$html$Html$div,
	$author$project$Projects$AbarthHatchbackSwitch$topStyle,
	_List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Buy and assemble a 3D printer.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('Learn enough CAD to construct the basic shell + plunger design.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('Steal some nickel strips from a spot-welding kit.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('Steal the spring from a ballpoint pen - cut it in half.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('Assemble and test fit the part.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('Learn how to add tolerances to parts in CAD software.')
								])),
							A2(
							$elm$html$Html$li,
							_List_Nil,
