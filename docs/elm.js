...
var $author$project$Domain$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $author$project$Domain$UrlChanged = function (a) {
	...
	function (msg, model) {
		if (msg.$ === 'LinkClicked') {
			...
			if (urlRequest.$ === 'Internal') {
				...
				return A2($elm$core$String$startsWith, '/pages/', url.path) ? _Utils_Tuple2(
					model,
...
var $author$project$Main$linkBar = A2(
	...
	_List_fromArray(
		[
			...
			A2($elm$html$Html$Attributes$style, 'right', '5%')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href('https://github.com/kadenjtaylor')
				]),
			_List_fromArray(
				[
					A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href('https://github.com/kadenjtaylor/resumaker/raw/main/latex/kaden_taylor_resume.pdf')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Main$gridSquareWriteup = function (w) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$projectGrid = function (ps) {
	var writeupSquares = A2($elm$core$List$map, $author$project$Main$gridSquareWriteup, ps.writeups);
	var externalSquares = A2($elm$core$List$map, $author$project$Main$gridSquareExternal, ps.external);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$homePage = function (model) {
	return _List_fromArray(
		[
			...
			$author$project$Main$projectGrid(model.projects)
		]);
};
...
var $author$project$Main$view = function (model) {
	var targetWriteup = $elm$core$List$head(
		A2(
			$elm$core$List$filter,
			function (w) {
				return _Utils_eq(w.url, model.url.path);
			},
			model.projects.writeups));
	if (targetWriteup.$ === 'Just') {
		var w = targetWriteup.a;
		return {body: w.content, title: w.title};
	} else {
		var _v1 = model.url.path;
		if (_v1 === '/') {
			return {
				body: $author$project$Main$homePage(model),
				title: 'Kaden.DEV'
			};
		} else {
			return {
				body: $author$project$Main$notFoundPage(model),
				title: 'NOT FOUND'
			};
		}
	}
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$init, onUrlChange: $author$project$Domain$UrlChanged, onUrlRequest: $author$project$Domain$LinkClicked, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
